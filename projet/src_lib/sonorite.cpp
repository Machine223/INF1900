...
/**********************************************************************
* Fonction: Sonorite::jouerSonoriteSonGrave
* Description: Emettre un son grave
* Paramètres: Aucun
* Retour: Auncun
**********************************************************************/ 
void Sonorite::jouerSonoriteSonGrave()
{
	PWMSonorite(tempsActif(108));
}

/**********************************************************************
* Fonction: Sonorite::jouerSonoriteSonAigu
* Description: Emettre un son aigu
* Paramètres: Aucun
* Retour: Auncun
********************************************************************/
void Sonorite::jouerSonoriteSonAigu()
{
	PWMSonorite(tempsActif(23));
}
